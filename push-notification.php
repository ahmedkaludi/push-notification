...
define('PUSH_NOTIFICATION_PLUGIN_VERSION', '1.46');
 ...
 */
add_action('admin_enqueue_scripts', 'push_notification_enqueue_bfcm_assets');

function push_notification_enqueue_bfcm_assets($hook) { 
 
    
    if ( $hook !== 'toplevel_page_push-notification') {
        return;
    }

    // 2. define settings
    $expiry_date_str = '2025-12-25 23:59:59'; 
    $offer_link      = 'https://pushnotifications.io/home/upgrade';
    ...
    wp_enqueue_style(
        'pn-bfcm-style', 
        PUSH_NOTIFICATION_PLUGIN_URL. 'assets/css/bfcm-style.css', 
        array(), 
    ...
    wp_enqueue_script(
        'pn-bfcm-script', 
        PUSH_NOTIFICATION_PLUGIN_URL. 'assets/js/bfcm-script.js', 
    ...
    wp_localize_script('pn-bfcm-script', 'bfcmData', array(
